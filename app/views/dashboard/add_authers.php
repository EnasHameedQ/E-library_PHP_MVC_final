      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card mb-4">
              <h5 class="card-header">اضافه مؤلف</h5>
              <form class="card-body" action="/save_author" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-3">
                    ...
                    <input name="phone" type="number" id="multicol-username" class="form-control" placeholder="john.doe" />
                  </div>
                  ...
                  <div class="row g-3">
                    ...
                    <div class="col-md-6">
                      ...
                      <textarea name="bio" id="multicol-username" class="form-control" placeholder="john.doe"></textarea>
                    </div>
