              ...
              <form class="card-body" action="/update_author" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-3">
                    ...
                    <input name="email" type="email" value="<?php echo $params->email; ?>" class="form-control" aria-describedby="multicol-email2" />

                  </div>
                  <div class="col-md-3">
                    <label class="form-label" for="multicol-username">رقم الهاتف </label>
                    <input name="phone" type="number" value="<?php echo $params->phone; ?>" id="multicol-username" class="form-control" placeholder="john.doe" />
                  </div>


                  <div class="row g-3">
                    <div class="col-md-6">
                      <label class="form-label" for="multicol-username">نبذه مختصره </label>
                      <textarea name="bio" id="multicol-username" class="form-control" placeholder="john.doe"><?php echo $params->bio; ?></textarea>
                    </div>
