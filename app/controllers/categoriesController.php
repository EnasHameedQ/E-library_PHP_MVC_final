...
class CategoriesController extends Controller{
        ...
        $this->viewDashboard('category',$allCategories);
    ...
    function listAll($parameters=null){
        ...
        $this->viewDashboard('list_categories',$allCategories);

    }
    function create(){
        $this->viewDashboard('add_category');
    ...
    function edit($params=[]){
        ...
        $this->viewDashboard('edit_category',$result);
    ...
    public function remove($params=[]){
        ...
        // $this->viewDashboard('remove_category',$result);
